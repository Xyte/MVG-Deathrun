...
resource.AddFile( "materials/background/metaversefinal.png" )
resource.AddFile( "materials/background/score_board_image_2.png" )
resource.AddFile( "materials/background/connerscore.png" )
resource.AddFile( "materials/background/missjackson.png" )
resource.AddFile( "materials/background/nameless.png" )
resource.AddFile( "materials/background/score_board_image_glados.png" )
resource.AddFile( "materials/background/score_board_image_beach.png" )
resource.AddFile( "materials/actrololo/birthday_cake.png")
resource.AddFile( "materials/actrololo/happybd.png")
resource.AddFile( "materials/actrololo/birthday_balloon.png")
...
AddCSLuaFile( "birthday.lua" )
AddCSLuaFile( "cl_placement.lua" )
...
local pickup = CreateConVar( "dr_allow_death_pickup", "1", FCVAR_ARCHIVE )
...
function GM:PlayerSpawn( ply )
	...
	ply:SetPlayerColor( Vector( col.r/255, col.g/255, col.b/255 ) )
		...
		local spawn = ply:Team() == TEAM_RUNNER and GetRunnerSpawnPoint() or GetDeathSpawnPoint()
		ply:SetPos( spawn )
...
function GM:PlayerCanPickupWeapon( ply, wep )
	...
	if ply:Team() == TEAM_DEATH then
		if pickup and wep:GetClass() != "weapon_crowbar" and tonumber(pickup) == 0 then
			return true
		end
	end
...
hook.Add("PlayerCanSeePlayersChat", "ffsstupidchat_fix", function( text, teamOnly, listener, speaker )
	if speaker == NULL then
		SendChatText( listener, Color(255,0,0), "Owner in console: "..text )
		return false
	end
end)
