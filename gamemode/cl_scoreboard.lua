...
local bg = Material("materials/background/metaversefinal.png", "smooth alphatest")
...
local pBackgrounds = {}
pBackgrounds["STEAM_0:0:86092282"] = Material("materials/background/connerscore.png", "smooth")
pBackgrounds["STEAM_0:1:42754969"] = Material("materials/background/score board image 2.png", "smooth")
pBackgrounds["STEAM_0:0:59527977"] = Material("materials/background/missjackson.png", "smooth")
pBackgrounds["STEAM_0:0:59637877"] = Material("materials/background/nameless.png", "smooth")
pBackgrounds["STEAM_0:1:49328995"] = Material("materials/background/score_board_image_glados.png", "smooth")
pBackgrounds["STEAM_0:0:47240930"] = Material("materials/background/score_board_image_beach.png", "smooth")
...
local PLAYER_LINE_PRE = {
	...
	Init = function(self, pl)
		...
		-- Level
		self.pLevel = self:Add("DLabel")
		self.pLevel:SetFont("Deathrun_Smooth")
		self.pLevel:SetPos(430, 8)
	end,
	...
	Setup = function(self, pl)
		...
		-- Level
		 self.pLevel:SetText("Lvl "..(pl.Level or 0))


		-- Get Color
		local playercolor = GAMEMODE:GetScoreboardNameColor(self.pPlayer) or hook.Call("GetScoreboardNameColor", nil, self.pPlayer) or Color(255, 255, 255, 255)
		self.pName:SetTextColor(playercolor)
...
SCOREBOARD = {
	...
	Paint = function(self, w, h)
		...
		draw.SimpleText("Level", "HudHintTextSmall", 440, textpos, color_white, TEXT_ALIGN_CENTER)
